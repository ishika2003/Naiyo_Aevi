...
# Add project root directory to the beginning of sys.path
...
def main():
    ...
    if db_response in ['y', 'yes']:
        if not setup_database():
            print("⚠️  Database setup failed, but you can run 'python scripts/init_db.py' later")
    else:
        print("⏭️  Skipping database setup. Run 'python scripts/init_db.py' when ready.")
